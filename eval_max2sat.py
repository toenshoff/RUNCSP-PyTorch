...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_dir", type=str, default='models/max2sat/test', help="Model directory")
    parser.add_argument("--data_path", type=str, default='data/Spinglass_2SAT/*.cnf', help="Path to the training data")
    parser.add_argument("--num_boost", type=int, default=64, help="Number of parallel runs")
    parser.add_argument("--network_steps", type=int, default=100, help="Number of network steps")
    ...
    data = [CSP_Data.load_2cnf(p) for p in tqdm(glob(args.data_path))]
